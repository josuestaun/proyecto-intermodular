...
var app = express();
var puntuacionesSchema = new mongoose.Schema({
    nombre: {
        type: String,
        required: true,
        minlength: 1
...
var Puntuacion = mongoose.model('puntuaciones', puntuacionesSchema);
...
app.get('/puntuaciones', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var puntuaciones;
...
app.post('/puntuaciones', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
...
app["delete"]('/puntuaciones/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
...
app.put('/puntuacion/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var puntuacion, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, Puntuacion.findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                puntuacion = _a.sent();
                return [4 /*yield*/, Puntuacion.save()];
            case 2:
